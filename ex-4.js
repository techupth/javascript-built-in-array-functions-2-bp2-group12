...
// Start coding here
let notNullMembers = bills.filter(memberName);
let numberMembers = notNullMembers.map(memberName);
let totalMembers = numberMembers.filter((name, index) => numberMembers.indexOf(name) == index);

function memberName(bill) {
  if(bill.member != null) {
